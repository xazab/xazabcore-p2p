...
function builder(options) {
  ...
  if (!options.network) {
    options.network = xazabcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || xazabcore.Block;
  options.BlockHeader = options.BlockHeader || xazabcore.BlockHeader;
  options.Transaction = options.Transaction || xazabcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || xazabcore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || xazabcore.MnListDiff;
